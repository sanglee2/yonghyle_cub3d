...
/*   Updated: 2023/11/26 20:38:22 by sanglee2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_go_forward(t_mlx *mlx, t_ray *ray)
{
	if (ray->dir_x > 0)
	{
		if (mlx->map[(int)(ray->pos_y)][(int)(ray->pos_x \
		+ ray->dir_x * M + 0.1)] != '1')
	...
	if (ray->dir_y > 0)
	{	
		if (mlx->map[(int)(ray->pos_y + ray->dir_y * M \
		+ 0.1)][(int)(ray->pos_x)] != '1')
...
void	ft_go_left(t_mlx *mlx, t_ray *ray)
{
	...
	if (ray->dir_x > 0)
	{
		if (mlx->map[(int)(ray->pos_y - ray->dir_x \
		* M + 0.1)][(int)(ray->pos_x)] != '1')
